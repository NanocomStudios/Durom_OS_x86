...
i386-elf-ld -o "full_kernel.bin" -Ttext 0x1000 "font.o" "kernel_entry.o" "kernel.o" "VGA.o" "malloc.o" "io.o" "keyboard.o" "Nstring.o" "Nmath.o" "GUI.o" "ps2.o" "hdd.o" --oformat binary
