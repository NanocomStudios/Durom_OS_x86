...
cd ../BIN/
i686-elf-ld -o "full_kernel.bin" -Ttext 0x1000 "font.o" "boot2step.o" "bootloader.o" "VGA.o" "malloc.o" "io.o" "Nstring.o" "Nmath.o" "GUI.o" "hdd.o" "PCI.o" "fat32.o" --oformat binary
