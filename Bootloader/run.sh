...
i386-elf-gcc -ffreestanding -m32 -g -c -o "../BIN/kernel.o" kernel.cpp
...
i386-elf-gcc -ffreestanding -m32 -g -c -o "../BIN/keyboard.o" ../HID/keyboard.cpp
...
i386-elf-gcc -ffreestanding -m32 -g -c -o "../BIN/ps2.o" ../IO/ps2.cpp
...
cd ../BIN/
i386-elf-ld -o "full_kernel.bin" -Ttext 0x1000 "font.o" "boot2step.o" "kernel.o" "VGA.o" "malloc.o" "io.o" "keyboard.o" "Nstring.o" "Nmath.o" "GUI.o" "ps2.o" "hdd.o" "PCI.o" --oformat binary
